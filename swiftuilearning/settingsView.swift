...
class searchViewModel : ObservableObject {
    let settingsList : [tileModel] = [
        ...
        tileModel(icon:"iphone.smartbatterycase.gen2",
...
struct settingsView: View {
    ...
    var searchResults: [tileModel] {
        if viewModel.searchQuery.isEmpty {
            return viewModel.settingsList
         } else {
             return viewModel.settingsList.filter { $0.name.lowercased().contains(viewModel.searchQuery.lowercased()) }
         }
